    ...
    <div class="create-account-box-wrapper">
      <el-card class="create-account-box">
        ...
        <div class="form-body-wrapper">
          ...
          <el-form ref="formData" :model="fromData" @focusout.native="updateIsFromValidated">
            <el-row :gutter="20">
               <el-col :span="12">
            ...
            <el-row>
              <el-form-item :rules="rules.email" prop="email">
                        <el-input type="email" placeholder="Email" v-model="formData.email"></el-input>
              </el-form-item>
            </el-row>
        ...
        <div class="form-footer-wrapper">
          ...
          <div class="next-button-wrapper">
            <button v-bind:disabled="!updateIsFromValidated" @click="register">
              Next
            </button>
          </div>
        </div>
